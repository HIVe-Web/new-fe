    ...
    return (
        <MobActivityContainer>
            <MobActivityTextBox expanded={showDropDown1}>
                ...
                <MobDropDownText show={showDropDown1}>정기 세션은 매주 목요일 오후 6시에 인문사회관 D동 308호에서<br/>진행됩니다!<br/><br/></MobDropDownText>
            </MobActivityTextBox>
            ...
            <MobActivityTextBox expanded={showDropDown2}>
                ...
                정기 세션 이외에도 피그마 스터디, 코딩 스터디 등 다양한 활동들을 자체적으로 운영하고 있습니다.<br/><br/></MobDropDownText>
            </MobActivityTextBox>
            ...
            <MobActivityTextBox expanded={showDropDown3}>
                ...
                <MobDropDownText show={showDropDown3}>지원하신 서류와 면접 내용을 바탕으로 운영진이 구성할 예정입니다.<br/><br/></MobDropDownText>
            </MobActivityTextBox>
            ...
            <MobActivityTextBox expanded={showDropDown4}>
                ...
                추가적으로 창업 경험이 있는 하이브 기존 부원들로부터 많은 정보와 인사이트를 알아가실 수 있답니다!<br/><br/></MobDropDownText>
            </MobActivityTextBox>
