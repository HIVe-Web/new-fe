    ...
    return (
        <MobApplyContainer>
            ...
            <MobApplyTextBox expanded={showDropDown2} onClick={toggleDropDown2}>
                ...
                포트폴리오가 없으신 분들은 서류에서 창업에 대한 의지와 하이브 활동에 대한 열정을 중점으로 지원자님을 어필해보세요!<br/>
                </MobDropDownText>
            </MobApplyTextBox>
            ...
            <MobApplyTextBox expanded={showDropDown4} onClick={toggleDropDown4}>
                ...
                <MobDropDownText show={showDropDown4}>서류, 면접 결과 모두 기재해주신 연락처로 합불 여부에 대해 연락을 드릴 예정입니다!<br/></MobDropDownText>
            </MobApplyTextBox>
        </MobApplyContainer>
    );
};
